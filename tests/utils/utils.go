...
func VirtualMachineImportCr(provider string, vmID string, namespace string, secretName string, prefix string, startVM bool) v2vv1alpha1.VirtualMachineImport {
...
func VirtualMachineImportCrWithName(provider string, vmID string, namespace string, secretName string, prefix string, startVM bool, targetVMName string) v2vv1alpha1.VirtualMachineImport {
	vm := v2vv1alpha1.VirtualMachineImport{
	...
	case framework.ProviderOvirt:
		vm.Spec.Source = v2vv1alpha1.VirtualMachineImportSourceSpec{
	...
	case framework.ProviderVmware:
		vm.Spec.Source = v2vv1alpha1.VirtualMachineImportSourceSpec{
			Vmware: &v2vv1alpha1.VirtualMachineImportVmwareSourceSpec{
				VM: v2vv1alpha1.VirtualMachineImportVmwareSourceVMSpec{ID: &vmID},
			},
		}
	}
	return vm
